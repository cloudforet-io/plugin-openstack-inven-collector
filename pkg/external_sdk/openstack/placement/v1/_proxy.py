...
class Proxy(proxy.Proxy):
    ...
    def get_resource_providers_inventories(self, resource_provider):

        base_path = f"{_resource_provider.ResourceProviderInventory.base_path}/{resource_provider}/inventories"
        return self._get(
            _resource_provider.ResourceProviderInventory, resource_provider, base_path=base_path,
            requires_id=False
        )

    def get_resource_providers_usages(self, resource_provider):

        base_path = f"{_resource_provider.ResourceProviderInventory.base_path}/{resource_provider}/usages"
        return self._get(
            _resource_provider.ResourceProviderUsage, resource_provider, base_path=base_path,
            requires_id=False
        )
