...
class Proxy(proxy.Proxy):
    ...
    ## Add for detail quota_sets
    def get_quota_set_detail(self, project):

        project = self._get_resource(_project.Project, project)

        return self._get(_quota_set.QuotaSetDetail, None, requires_id=False,
                         base_path=f"/os-quota-sets/{project.id}/detail")
