...
CS_SHARE_META.append_cst_meta_field('TextDyField', 'ID', 'data.id', index=0)
CS_SHARE_META.insert_cst_meta_field('ID', 'TextDyField', 'Name', 'data.name')
CS_SHARE_META.insert_cst_meta_field('Name', 'TextDyField', 'Description', 'data.description')
...
CS_SHARE_NET_META.append_cst_meta_field('BadgeDyField', 'Subnet ID', 'neutron_subnet_id',
                                        reference={"resource_type": "inventory.CloudService",
                                                   "reference_key": "reference.resource_id"}
                                        )
