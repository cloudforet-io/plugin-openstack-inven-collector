...
CS_SNAPSHOT_META.append_cst_meta_field('TextDyField', 'ID', 'data.id', index=0)
CS_SNAPSHOT_META.insert_cst_meta_field('ID', 'TextDyField', 'Name', 'data.name')
CS_SNAPSHOT_META.insert_cst_meta_field('Name', 'TextDyField', 'Description', 'data.description')
