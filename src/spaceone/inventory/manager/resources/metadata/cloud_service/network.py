...
CS_NETWORK_META = CSTMetaGenerator(CST_NETWORK_META)

CS_NETWORK_META.append_cst_meta_field('TextDyField', 'ID', 'data.id', index=0)
CS_NETWORK_META.insert_cst_meta_field('ID', 'TextDyField', 'Name', 'data.name')
CS_NETWORK_META.insert_cst_meta_field('Name', 'TextDyField', 'Description', 'data.description')
CS_NETWORK_META.append_cst_meta_field('TextDyField', 'externalLink', 'data.external_link')

CLOUD_SERVICE_BASE = ItemDynamicLayout.set_fields('Network', fields=CS_NETWORK_META.fields)
