...
CS_FLOATING_IP_META.append_cst_meta_field('TextDyField', 'ID', 'data.id', index=0)
CS_FLOATING_IP_META.insert_cst_meta_field('ID', 'TextDyField', 'Name', 'data.name')
CS_FLOATING_IP_META.insert_cst_meta_field('Name', 'TextDyField', 'Description', 'data.description')
