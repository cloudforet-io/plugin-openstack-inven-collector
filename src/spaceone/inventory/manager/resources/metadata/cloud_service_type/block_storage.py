...
CST_VOLUME_META.append_cst_meta_field('EnumDyField', 'Encrypted', 'data.is_encrypted', auto_search=True,
                                      default_badge={'indigo.500': ['true'], 'coral.600': ['false']})
CST_VOLUME_META.append_cst_meta_field('ListDyField', 'Attached Instance ID', 'data.attachments', auto_search=True,
                                      reference={"resource_type": "inventory.CloudService",
                                                 "reference_key": "reference.resource_id"},
